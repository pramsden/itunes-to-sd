...
public class ItunesLibraryParsedDataImpl implements ItunesLibraryParsedData {
	 ...
	 */
	public ItunesLibraryParsedDataImpl(final LibraryObject root, final Playlist[] allPlaylists, final Track[] allTracks,
			final Map<Long, Track[]> plistTrackMap) throws NoChildrenException {
		this.root = root;
	...
	public Track[] getPlaylistTracks(final String playlistName) throws InvalidPlaylistException {
	...
	public Playlist getPlaylist(final Long playlistId) throws InvalidPlaylistException {
		for (final Playlist playlist : getAllPlaylists()) {
